...
public struct CharacterSkills {
    ...
    public float[] SkillStats(int skillID) {
        ...
        // NOTE -- Element 0 is the skill's damage/healing/stat buffing capabilities
        ...
        //         Element 4 is the skill's damage/healing/buffing size (Single Target, AoE, Full Row, etc)
