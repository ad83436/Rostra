...
public enum SKILL_TYPE{ // Minimum Value -- 0xFFF0, Maximum Value -- 0xFFFF (16 possible skill types)
    ...
    SINGLE_PLAYER_BUFF =    0XFFF5,     // Skills of this type will buff a single player's stat(s)
    ALL_PLAYER_BUFF =       0xFFF6,     // Skills of this type will buff all player character stats
};